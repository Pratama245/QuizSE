...
if __name__ == '__main__' :
    Try1 = Assignment1("localhost", "3306", "root", "")
    Try1.create_db("HargaEmas")
    df = Try1.import_csv("gold_karat.csv")
    Try1.create_table("HargaEmas","Katalog",df)
    print(Try1.load_data("HargaEmas","Katalog"))
